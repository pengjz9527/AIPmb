...
class ManageHeldWealth {
  ...
  factory ManageHeldWealth.fromJson(Map<String, dynamic> json) => ManageHeldWealth(
    id: json['id']?.toString() ?? '',
...
class ManageHeldLoan {
  ...
  factory ManageHeldLoan.fromJson(Map<String, dynamic> json) => ManageHeldLoan(
    id: json['id']?.toString() ?? '',
...
class ManageHeldPension {
  ...
  factory ManageHeldPension.fromJson(Map<String, dynamic> json) => ManageHeldPension(
    id: json['id']?.toString() ?? '',
...
class ManageHeldSummary {
  ...
  final List<ManageHeldWealth> wealthProducts;
  final List<ManageHeldLoan> loans;
  final List<ManageHeldPension> pensions;
  ...
  ManageHeldSummary({
    ...
    required this.wealthProducts,
    required this.loans,
    required this.pensions,
  });

  factory ManageHeldSummary.fromJson(Map<String, dynamic> json) {
    final wealth = json['wealth'] ?? {};
    final loans = json['loans'] ?? {};
    final pensions = json['pensions'] ?? {};
    return ManageHeldSummary(
      ...
      wealthProducts: (wealth['products'] as List<dynamic>? ?? [])
          .map((e) => ManageHeldWealth.fromJson(e as Map<String, dynamic>))
          .toList(),
      loans: (loans['items'] as List<dynamic>? ?? [])
          .map((e) => ManageHeldLoan.fromJson(e as Map<String, dynamic>))
          .toList(),
      pensions: (pensions['items'] as List<dynamic>? ?? [])
          .map((e) => ManageHeldPension.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
}
